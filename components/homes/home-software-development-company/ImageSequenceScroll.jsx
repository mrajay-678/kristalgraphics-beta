...
const ImageSequenceScroll = () => {
  ...
  useEffect(() => {
    const frameCount = 175; // total PNG frames
  ...
  return (
    <section className="mid-animation pb-52" style={{ minHeight: "100vh" }}>
      <div>
        <div className="flex justify-between mx-auto max-w-[1200px] items-start">
          <div className="flex flex-col w-2/4 gap-5 pb-32">
            <div className="flex items-center gap-7">
              ...
              <RevealText className="reveal-type">
                <div className="font-light leading-none text-[70px] font-heading reveal-type ">
