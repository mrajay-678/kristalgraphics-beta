  ...
  return (
    <>
      <main id="mxd-page-content" className="mxd-page-content">
        <Hero />
        <MarqueeSlider img="logo" className="" items={["Design", "Development", "Branding", "Strategy","Design", "Development", "Branding", "Strategy","Design", "Development", "Branding", "Strategy","Design", "Development", "Branding", "Strategy"]} />
        <Capabilities />
        <ImageSequenceScroll />
        <Instagram />
        <section className="mt-52">
          <MarqueeSlider img="round-logo" className="text-[#D9D9D9]" items={["Brands that trust us", "Brands that trust us", "Brands that trust us", "Brands that trust us"]} />
        </section>
