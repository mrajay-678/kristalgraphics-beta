  ...
  return (
    <>
      <main id="mxd-page-content" className="mxd-page-content">
        <Hero />
        <MarqueeSlider className="" items={["Design", "Development", "Branding", "Strategy","Design", "Development", "Branding", "Strategy","Design", "Development", "Branding", "Strategy","Design", "Development", "Branding", "Strategy"]} />
        <Capabilities />
        <ImageSequenceScroll />
        <Instagram />
